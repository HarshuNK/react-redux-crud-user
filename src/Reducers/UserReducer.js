...
import { createUsers, retriveUsers, retriveSingleUser, updateUser, deleteUser } from "../Actions/UserAction";
        ...
        builder.addCase(createUsers.fulfilled, (state,action) => {
            state.push(action.payload.user)
                ...
                .addCase(deleteUser.fulfilled, (state,action) => {
                    let userIndex = state.findIndex(itemitem => itemitem._id === action.payload.id)
